    ...
    return (
        <div className="w-full bg-[#f5f5f9] pb-8 md:pb-16 ">
            <div className="container mx-auto px-2 md:px-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-5 px-1">
